...
class ServiceController extends Controller
{
    ...
    public function export()
    {
        ...
        $columns = array('Workspace ID', 'Client', 'Provider', 'Starts At', 'Ends At', 'Service Provided');
        ...
        $callback = function() use($consultations, $columns) {
            ...
            foreach ($consultations as $consultation) {
                ...
                $row['Service Provided'] = $consultation->service->type->description . ' - ' . $consultation->service->name;

                fputcsv($file, array($row['Workspace ID'], $row['Client'], $row['Provider'], $row['Starts At'], $row['Ends At'], $row['Service Provided']));
            }
